...
def create_question(q_text, days):
    """
    Creates a question with the given `q_text` and published the
...
class QuestionMethodTests(TestCase):
    ...
    def test_index_views_with_no_questions(self):
        """
    ...
    def test_detail_view_with_a_past_question(self):
        ...
        """
        past_question = create_question(q_text="Past Question.", days=-5)
